 ...
 * экземпляр.
 * Если объект не имеет имени, к нему можно обратиться из Java-кода через ссылку Companion:
 *      /* Java */
 *      Person.Companion.fromJSON("...");
 * Если у объекта есть имя, вместо Companion нужно использовать его. Но вам может понадобиться работать с Java-кодом,
 ...
 * свойством, объявленным в объекте. Эти аннотации нужны только для совместимости и, строго говоря, не являются
 * частью ядра языка.
 */
fun main() {
