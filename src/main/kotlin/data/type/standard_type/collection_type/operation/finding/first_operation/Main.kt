package data.type.standard_type.collection_type.operation.finding.first_operation
...
/**
 * Function 'first()' is used to find the first element in the collection that match to a predicate.
 *
...
fun main() {
    ...
    val findResult_1 = listOfString.first { it.startsWith(targetValue_1) }
    val findResult_2 = listOfString.first { it.endsWith(targetValue_2) }
    // val findResult_3 = listOfString.first { it.endsWith(targetValue_3) }    // error: NoSuchElementException
    println(
    ...
    val findResult_4 = listOfPeople.first { it.age > targetValue_4 }
    val findResult_5 = listOfPeople.first { it.isFemale(it) }
    // val findResult_6 = listOfPeople.first { it.age > targetValue_5 }        // error: NoSuchElementException
    println(
